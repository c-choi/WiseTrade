...
<title>社長ブログ｜ワイズ通商株式会社｜一般区域貨物運送事業｜愛知県碧南市吹上町4-23-1</title>
<meta name="keywords" content="社長ブログ,ワイズ,通商,貨物,運送,愛知県碧南市,物流,輸送,トラック,特殊車両,中古車">
...
<div class="blog01">
    <h3>{val data/0}</h3>
    <h4>{val data/1}</h4>
    <h5 class="imgright"><a href="../images/ceoblog/{val data/3}" target="_blank"><img src="../images/ceoblog/{val data/3}" alt="" width="240" height="180"></a></h5>
    <p>{val data/2}</p>
</div><!-- end of blog01 -->
<!--{/each}--> 
<!--{/def}--> 
...
<li><a href="index.php">社長ブログ</a></li>
